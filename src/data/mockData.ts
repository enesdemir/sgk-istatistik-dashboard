...
export const sayiPanelleri: SayiPaneliData[] = [
  ...
  },
  {
    id: 'emekli',
    baslik: 'Emekli',
    altBaslik: 'net değişim · yeni bağlanan − vefat',
    gunluk: 3_430,
    aylik: 102_900,
    yillik: 1_235_000,
    format: 'compact',
  ...
  {
    id: 'denetlenen-isyeri',
    baslik: 'Denetlenen İş Yeri',
    altBaslik: 'saha denetimi sayısı',
    gunluk: 960,
    aylik: 29_200,
    yillik: 350_400,
    format: 'compact',
    durum: 'info',
    toplam: {
      etiket: 'Toplam Aktif İşyeri',
      deger: 2_438_500,
    },
  },
  {
    id: 'uygulanan-ceza',
    baslik: 'Uygulanan Ceza',
    altBaslik: 'idari para cezası',
    gunluk: 13_150_000,
    aylik: 395_200_000,
    yillik: 4_840_000_000,
    format: 'tl',
    durum: 'warn',
  },
  {
